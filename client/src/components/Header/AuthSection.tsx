...
const AuthSection = ({
   ...
   return (
      <div className='flex items-center gap-4 text-white'>
         ...
         <div className={clsx('flex gap-2', showSearch ? 'hidden' : 'block')}>
         ...
         <form className='relative h-8 min-w-8' onSubmit={handleFormSubmission}>
            ...
            >
               <input
                  ...
                  id='search'
                  placeholder='Search'
                  className='h-full w-80 rounded-full border bg-black bg-opacity-20 pl-4 pr-10 placeholder:text-zinc-300 focus:outline-none'
               />
            </motion.div>
            <button
               type='submit'
